...
var sqlServer = builder.AddSqlServer("sqlserver", dbPassword, 57386)
    .WithContainerName("shoppinglist-sqlserver");
...
var migrations = builder.AddExecutable("db-migrations", "dotnet", "../../src/ShoppingList.Server",
    [
        "ef",
        "database",
        "update",
...
builder.AddProject<Projects.ShoppingList_Server>("server", "https")
